...
if(isset($_POST['submit'])){
	...
	$educationmessage = $_POST['educationmessage'];
	$yrsexperience = $_POST['yearsexperience'];
	$experiencesummary = $_POST['experiencesummary'];
	$experienceareas = $_POST['experienceareas'];
	$bestcontactmethod = $_POST['bestcontactmethod'];
	$jobtype = $_POST['jobtype'];
	$otherinfo = $_POST['otherinfo'];
	$interestinginfo = $_POST['interestinginfo'];
